...
def train_and_eval(model_dir, model_type, train_steps, train_data, test_data):
  ...
  df_test = pd.read_csv(
      ...
      skiprows=1,
      engine="python")
  print('before length', len(df_train), len(df_test))
  # remove NaN elements
  df_train = df_train.dropna(how='any', axis=0)
  df_test = df_test.dropna(how='any', axis=0)
  print('after length', len(df_train), len(df_test))
  ...
  '''
  model_dir 이 None/False 가 아니면 model_dir 이 들어가고, 그렇지 않다면 tempfile.mkdtemp()가 호출된다.
  '''
